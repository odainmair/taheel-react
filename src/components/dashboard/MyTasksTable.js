                    ...
                    {request && (
                      <IconButton
                        ...
                        onClick={() => {
                          ...
                          navigate('/services/finallicense', { state: { centerLicenceNumber: request.centerLicenceNumber, taskID: request.ID,requestNum:request.requestNum, formType: LICENSE_FORM_TYPES.EDIT } });
                        }}
                      >
                        <VisibilityIcon />
                      </IconButton>
