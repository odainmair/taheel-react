...
export default function FormCreator({ title, pageName, isLoading, submitInfo, schema, initValues, sectionNames, cancel, formType, lookupObject, additionalFields, fieldsName, errMessage }) {
